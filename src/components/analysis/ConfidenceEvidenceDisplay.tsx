      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="surface-card p-5 space-y-5">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            ...
            <div className={cn('px-2 py-0.5 border text-xs font-semibold rounded', getConfidenceLevelStyle(confidence.level))}>
          ...
          <div className="flex items-baseline gap-3">
            ...
            <div className="text-xs text-slate-500">
              Calibration error: <span className="font-mono text-slate-700">{confidence.calibratedMargin}</span>
            </div>
          </div>
        ...
        <div className="lg:col-span-2 surface-card p-5 space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            ...
            <div className="text-xs text-slate-500 font-mono">
              {evidence.length} Cited Excerpts
            </div>
          </div>
